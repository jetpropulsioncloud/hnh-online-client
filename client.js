(() => {
  ...
  function installDirectManipulation(){
    ...
    const under=(x,y)=>document.elementFromPoint(x,y),recruitTarget=el=>el?.closest?.('[data-muster-uid]')||null,attackTarget=el=>el?.closest?.('[data-attack-building],[data-hearthseed-player]')||null,blockTarget=el=>el?.closest?.('.gameCard.critter[data-block-attack-index]')||null;
